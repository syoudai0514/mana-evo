...
export const SPECIES = {
  'starter-fire-1': { id: 'starter-fire-1', family: 'starter-fire', stage: 1, name: 'ほのおの相棒・幼体（仮）', types: ['fire'], base: { hp: 48, attack: 25, defense: 20, speed: 24 }, moves: ['tackle', 'ember', 'flameRush', 'rockHit'], evolvesAt: 8, evolvesTo: 'starter-fire-2', catchRank: 0 },
  'starter-fire-2': { id: 'starter-fire-2', family: 'starter-fire', stage: 2, name: 'ほのおの相棒・中間（仮）', types: ['fire'], base: { hp: 62, attack: 34, defense: 27, speed: 31 }, moves: ['tackle', 'ember', 'flameRush', 'rockHit'], evolvesAt: 14, evolvesTo: 'starter-fire-3', catchRank: 0 },
  ...
  'wild-grass-1': { id: 'wild-grass-1', family: 'wild-grass', stage: 1, name: 'くさの野生・幼体（仮）', types: ['grass'], base: { hp: 42, attack: 20, defense: 23, speed: 18 }, moves: ['tackle', 'leafShot', 'vineHit', 'bugBite'], evolvesAt: 10, evolvesTo: 'wild-grass-2', catchRank: 1 },
  'wild-grass-2': { id: 'wild-grass-2', family: 'wild-grass', stage: 2, name: 'くさの野生・中間（仮）', types: ['grass'], base: { hp: 57, attack: 29, defense: 32, speed: 24 }, moves: ['tackle', 'leafShot', 'vineHit', 'bugBite'], evolvesAt: 18, evolvesTo: 'wild-grass-3', catchRank: 2 },
  ...
  'wild-water-1': { id: 'wild-water-1', family: 'wild-water', stage: 1, name: 'みずの野生・幼体（仮）', types: ['water'], base: { hp: 44, attack: 21, defense: 21, speed: 21 }, moves: ['tackle', 'waterShot', 'aquaRush', 'gust'], evolvesAt: 10, evolvesTo: 'wild-water-2', catchRank: 1 },
  'wild-water-2': { id: 'wild-water-2', family: 'wild-water', stage: 2, name: 'みずの野生・中間（仮）', types: ['water'], base: { hp: 59, attack: 30, defense: 29, speed: 29 }, moves: ['tackle', 'waterShot', 'aquaRush', 'gust'], evolvesAt: 18, evolvesTo: 'wild-water-3', catchRank: 2 },
  ...
  'wild-electric-1': { id: 'wild-electric-1', family: 'wild-electric', stage: 1, name: 'でんきの野生・幼体（仮）', types: ['electric'], base: { hp: 40, attack: 22, defense: 18, speed: 28 }, moves: ['tackle', 'spark', 'thunderDash', 'gust'], evolvesAt: 9, evolvesTo: 'wild-electric-2', catchRank: 1 },
  'wild-electric-2': { id: 'wild-electric-2', family: 'wild-electric', stage: 2, name: 'でんきの野生・中間（仮）', types: ['electric'], base: { hp: 54, attack: 31, defense: 25, speed: 38 }, moves: ['tackle', 'spark', 'thunderDash', 'gust'], evolvesAt: 17, evolvesTo: 'wild-electric-3', catchRank: 2 },
  ...
  'wild-bug-1': { id: 'wild-bug-1', family: 'wild-bug', stage: 1, name: 'むしの野生・幼体（仮）', types: ['bug'], base: { hp: 36, attack: 18, defense: 18, speed: 24 }, moves: ['tackle', 'bugBite', 'leafShot', 'gust'], evolvesAt: 7, evolvesTo: 'wild-bug-2', catchRank: 1 },
  'wild-bug-2': { id: 'wild-bug-2', family: 'wild-bug', stage: 2, name: 'むしの野生・中間（仮）', types: ['bug', 'flying'], base: { hp: 47, attack: 25, defense: 22, speed: 34 }, moves: ['tackle', 'bugBite', 'gust', 'leafShot'], evolvesAt: 12, evolvesTo: 'wild-bug-3', catchRank: 2 },
