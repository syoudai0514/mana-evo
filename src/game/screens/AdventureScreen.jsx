...
import { AREA_META, STAGES, pickDailyEncounterStages, speciesOf, stageKindLabel } from '../content.js'
...
export function StageMap({ game, onStart, goStudy, goHome, dailyCompleted, today, location, onLocationChange }) {
