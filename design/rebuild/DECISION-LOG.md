...
- Reason: 5〜8歳のchild playtestでは抽象的な「わ」より、投げる対象・待つ時間・結果が身体的に理解しやすい。UI側でも画面間scroll leakage、safe-area衝突、小さすぎる問題visual、文字の不自然な分断は操作コストと認知負荷を増やすため。
